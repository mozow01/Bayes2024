...
1. **A szó szerinti hallgató ($L_0$ - Literal listener):**
   ...
   $$P_{L_0}(s \mid u) \propto 1_{u,s} \cdot P(s)$$

   (Itt $P(s)$ a világállapotok a priori valószínűsége, $1{u,s}$ pedig egy indikátorfüggvény, amelynek értéke 1, ha az $u$ megnyilatkozás szó szerinti jelentése igaz az $s$ állapotban, és 0, ha hamis.)
